...
RUN git clone https://github.com/thoriqtau/serverless-stablediffusion-ipadapter7.git

# Install the worker dependencies
WORKDIR /workspace/serverless-stablediffusion-ipadapter7/src
...
RUN cd /workspace/serverless-stablediffusion-ipadapter7/src && \
