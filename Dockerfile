...
RUN git clone https://github.com/thoriqtau/serverless-stablediffusion-ipadapter2.git

# Install the worker dependencies
WORKDIR /workspace/serverless-stablediffusion-ipadapter2/src
...
RUN cd /workspace/serverless-stablediffusion-ipadapter2/src && \
