...
RUN git clone https://github.com/thoriqtau/serverless-stablediffusion-ipadapter6.git

# Install the worker dependencies
WORKDIR /workspace/serverless-stablediffusion-ipadapter6/src
...
RUN cd /workspace/serverless-stablediffusion-ipadapter6/src && \
