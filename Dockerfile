...
RUN git clone https://github.com/thoriqtau/serverless-stable_diffusion-ipadapter.git

# Install the worker dependencies
WORKDIR /workspace/serverless-stable_diffusion-ipadapter/src
...
RUN cd /workspace/serverless-stable_diffusion-ipadapter/src && \
